-- default job/business bank accounts seeded on first startup; each entry's Permissions is built
-- lazily (function call, not module load time) since GetDefaultBankAccountPermissions() lives in banking.lua
function GetDefaultOrganizationAccounts()
	return {
		{
			accountId = "police",
